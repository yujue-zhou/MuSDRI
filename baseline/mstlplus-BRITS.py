...
# hyper-parameters
parser = argparse.ArgumentParser(description='mstlplus-BRITS algorithm on GAS dataset')
...
train_seasonal12 = pd.read_csv('./data/train/mstlplus_seasonal12.csv', index_col=0)
train_seasonal84 = pd.read_csv('./data/train/mstlplus_seasonal84.csv', index_col=0)
train_remainder = pd.read_csv('./data/train/mstlplus_remainder.csv', index_col=0)
train_trend = pd.read_csv('./data/train/mstlplus_trend.csv', index_col=0)
...
test_seasonal12 = pd.read_csv('./data/test/mstlplus_seasonal12.csv', index_col=0)
test_seasonal84 = pd.read_csv('./data/test/mstlplus_seasonal84.csv', index_col=0)
test_remainder = pd.read_csv('./data/test/mstlplus_remainder.csv', index_col=0)
...
for epoch in range(20):
  ...
  for index, data in enumerate(trainloader):
    ...
    if index%10==0:
      ...
      Y_predicted = Y_predicted+test_seasonal12+test_seasonal84+test_trend
      ...
      file = open("./losses/mstlplus-BRITS.txt","a")
      ...
      if test_loss<best_loss:
        ...
        save_point = './checkpoint/mstlplus-BRITS'
        torch.save(model_state, save_point)
        

print('finished training')
checkpoint = torch.load('./checkpoint/mstlplus-BRITS')
...
imputed_data.to_csv('./data/test/impute/mstlplus-BRITS.csv',index=0)
