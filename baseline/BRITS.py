...
# hyper-parameters
parser = argparse.ArgumentParser(description='BRITS algorithm on GAS dataset')
  ...
  for index, data in enumerate(trainloader):
    ...
    if index%10==0:
      ...
      if test_loss<best_loss:
        ...
        save_point = './checkpoint/BRITS'
        torch.save(model_state, save_point)
        

print('finished training')
checkpoint = torch.load('./checkpoint/BRITS')
...
imputed_data.to_csv('./data/test/impute/BRIRS.csv',index=0)
